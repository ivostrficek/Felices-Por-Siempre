...
import '../../assets/js/row-plugin.js';
import '../../assets/js/active.js';

import '../../assets/js/blueimp-helper.js';
import '../../assets/js/blueimp-gallery.js';
import '../../assets/js/blueimp-gallery-fullscreen.js';
import '../../assets/js/blueimp-gallery-indicator.js';
import '../../assets/js/blueimp-gallery-video.js';
import '../../assets/js/blueimp-gallery-vimeo.js';
import '../../assets/js/blueimp-gallery-youtube.js';
...
export class LandingComponent implements OnInit {
  ...
  getCeremoniaURL() {
    return this.sanitizer.bypassSecurityTrustResourceUrl(this.ceremoniaUrl);
  }

  getFiestaURL() {
    return this.sanitizer.bypassSecurityTrustResourceUrl(this.fiestaUrl);
  }
