        ...
        $('#mc-form').ajaxChimp({
          ...
          // Mailchimp translation
            ...
            $.ajaxChimp.translations.lj = {
              'submit': 'Enviando...',
              0: '<p  class="sdsf" > Tu confirmación ha sido enviada!</p>',
              1: '<p class="sdsf" > Ingresa un e-mail válido</p>',
              2: '<p> Tu dirección de E-mail no es válida.</p>',
              3: '<p> Tu dirección de E-mail no es válida.</p>',
              4: '<p> Tu dirección de E-mail no es válida.</p>',
              5: '<p> Tu dirección de E-mail no es válida.</p>'
            }
            ...
            $("#subscribe").submit(function (event) {
              var input = $('.boss-subscribe-message');
                ...
                if (email == "") {
                  ...
                  $(".boss-subscribe-message").stop(true).html(' <p> Debes ingresar un E-mail válido.</p>');
                  $("input#subscribe-email").focus();
                } 
                else if (!isValidEmailAddress( email )) {
                  $(".boss-subscribe-message").stop(true).html(' <p>Tu dirección de E-mail no es válida.</p>');
                  $("input#subscribe-email").focus();            
                }
                else {
                  $.ajax({
                    ...
                    success: function () {
                      $(".boss-subscribe-message").html(' <p>Tu confirmación ha sido enviada.</p>');
