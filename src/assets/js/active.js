   ...
   ========================================================================== */
    ...
    // your plugin activation here
     ...
     $(".boss-home-area").backstretch([
            "http://www.felicesporsiempre.com.ar/sabriylelu/images/PORTADA1.jpg"
          ],{duration: 4000, fade: 1000});

     // countdown
      // To change date, simply edit: var endDate = "May 26, 2015 20:39:00";
      var endDate = "April 8, 2017 20:15:00";
        $('.boss-countdown').countdown({
          date: endDate,
          render: function(data) {
            $(this.el).html('<div><div><span>' + this.leadingZeros(data.days, 2) + '</span><span>días</span></div><div><span>' + this.leadingZeros(data.hours, 2) + '</span><span>horas</span></div></div><div class="boss-countdown"><div><span>' + this.leadingZeros(data.min, 2) + '</span><span>minutos</span></div><div><span>' + this.leadingZeros(data.sec, 2) + '</span><span>segundos</span></div></div>');
          }
        });
